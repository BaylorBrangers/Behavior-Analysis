...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 18 12:22:12 2018
    ...
    def read_accelerometer_data(self,file_name):
        ...
        with open (file_name, 'r') as f:
            ...
            for line in reader:
                ...
                self.timestamps.append(line[1])
                self.x_data.append(line[2])
                self.y_data.append(line[3])
                self.z_data.append(line[4])
            ...
            return self.timestamps, self.x_data , self.y_data , self.z_data

class process_data(accelerometer_profile):
    """ generates a shuffled data object and
    allows you to do some modivications and different types
    of windowing"""

    def __init__(self,accl_name):
        self.name=accl_name

    def shuffle_data(size, accl,labels):
        """retruns a randomly shuffled array for
        training"""


        return shuffle_accl,shuffle_labels

    def window_data_slide(selfname,window_size):
        """returns and array with elements equal to
        window size. This array has overlapping values.
        Default is 100 milliseconds. This can be used either
        for training or model evaluation"""


        return sliding_window_data


    def window_data_noSlide(self,name,window_size):
        """returns an array with
        elements equal to window size. This array has
        non-overlapping values and is best used for
        comparing models to ground truth data"""




def smooth_data(data_array,type_of_smoothing):
    """running average"""
